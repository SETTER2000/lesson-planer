...
export class LessonService {
    data: Lesson[] = [
        ...
        {id: 2, name: 'Lesson 2', completed: false},
        ...
        {id: 9, name: 'Lesson 9', completed: true},
        {id: 10, name: 'Lesson 10', completed: false},
        {id: 11, name: 'Lesson 11', completed: false}
    ];
    ...
    update(lesson: Lesson){
        let toUpdate = this.getById(lesson.id);
